...
public class AuthController {
    ...
    public ModelAndView permList() {
        ...
        try {
            List<Permission> permList = permissionService.searchPermission(new PermissionQuery());
        ...
        try {
            if (null != permission) {
                ...
                if (0 == type) {
                    ...
                    //编辑权限
                    this.permissionService.updatePartPermission(permission);
                } else if (1 == type) {
    ...
    public Permission getPerm(@RequestParam("id") int id) {
        ...
        try {
            if (id > 0) {
                Permission perm = this.permissionService.getPermissionById(id);
...
//            return this.authService.getRoles();
    ...
    public List<PermissionVo> getUserPerms() {
        ...
        try {
            pvo = permissionService.getPermissionByUserId(existUser.getId());
            //生成页面需要的json格式
