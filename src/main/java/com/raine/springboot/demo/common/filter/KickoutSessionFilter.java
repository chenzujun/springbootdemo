package com.raine.springboot.demo.common.filter;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.raine.springboot.demo.common.enums.EnumSystemStatus;
import com.raine.springboot.demo.common.utils.ShiroFilterUtils;
    ...
    protected boolean onAccessDenied(ServletRequest request,
        ...
        if (!subject.isAuthenticated() && !subject.isRemembered()) {
            ...
            if (ShiroFilterUtils.isAjax(request)) {
                ...
                responseResult.setCode(EnumSystemStatus.MANY_LOGINS.getCode());
        ...
        logger.debug("===当前请求的uri：=={} | 域名或ip+端口={}", path, contextPath);
        //放行登录
